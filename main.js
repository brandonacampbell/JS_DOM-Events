...
node1.textContent ="I used the getElementByClassName('node2') method to access this";
...
function show() {
    ...
    h2.textContent = "this is a modal.";
    p.textContent = "modal content";
    closeBtn.textContent = "Close";

    //add an event listener to the modal closeBtn
    // This will remove the modal from the body
